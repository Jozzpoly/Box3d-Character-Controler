...
const SUITES = {
  research: [
    ...
    { name: 'E12 graded capacity entitlement', scripts: ['scripts/e12-0a-capacity-entitled-residual.mjs','scripts/e12-1a-capacity-entitled-braking.mjs','scripts/e12-2a-dynamic-support-placement-calibration.mjs'] },
  ],
  donor: [
