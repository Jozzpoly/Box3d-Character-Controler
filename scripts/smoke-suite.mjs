...
const SUITES = {
  ...
  current: [
    ...
    { name: 'E18 P3 Owner-probe lifecycle regression', scripts: ['scripts/e18/e18-p3-1a-staged-lifecycle-smoke.mjs'] },
    { name: 'E19 representative swept-reach reciprocal-grip regression', scripts: ['scripts/e19/e19-1e-swept-reach-live-grip.mjs'] },
  ],
};
