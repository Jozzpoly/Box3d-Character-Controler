...
const SUITES = {
  research: [
    ...
    { name: 'E13 world-coupled authority placement binding', scripts: ['scripts/e13-0b-prismatic-world-stop-binding.mjs','scripts/e13-0c-embodied-free-prismatic-representation.mjs'] },
  ],
  donor: [
