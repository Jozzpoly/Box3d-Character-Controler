...
const SUITES = {
  research: [
    ...
    { name: 'E10 one-piece support brace', scripts: ['scripts/e10-0a-revolute-current-angle-latch.mjs','scripts/e10-0b-acquired-support-brace-transition.mjs','scripts/e10-1b-demand-aligned-brace-stability.mjs'] },
  ],
  donor: [
