...
const SUITES = {
  research: [
    ...
    { name: 'E11 residual-contact interaction diagnostics', scripts: ['scripts/e11-1a-residual-contact-interaction-decomposition.mjs','scripts/e11-2a-support-relevance-counterfactual.mjs'] },
  ],
  donor: [
